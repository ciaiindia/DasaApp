...
def fetch_and_summarize_trial_for_client_state():
    ...
    # --- Generate Summary ---
    prompt_trial_template = """You are an expert clinical trial analyst. Summarize the key aspects of the following clinical trial based *only* on the provided JSON data. Structure your summary into exactly three categories as specified below. Be concise and factual.
